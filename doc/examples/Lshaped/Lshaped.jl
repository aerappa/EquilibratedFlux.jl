...
save("soln_coarse.png", u_fig) #src
#md # ![](soln_coarse.png)
...
# This step just corresponds almost exact to the contents of the [first Gridap.jl tutorial](https://gridap.github.io/Tutorials/dev/pages/t001_poisson/#Tutorial-1:-Poisson-equation-1).
...
# ![](animation.gif)
#wireframe!(Ω, color=:black, linewidth=2);
#save("trian_fig_ref.png", Ω_fig) #src
#-
